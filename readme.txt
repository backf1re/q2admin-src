...
2.13 cl_pitchspeed (Action Quake2 M4 Scripts)
...
4. Copy the q2admin.txt into the Quake2 root directory 
...
running it with that vresion.  Use at your own risk.
...
Admin Setup:
  ...
  serverinfoenable                - enable/disable 'set bot "no bots" S'
...
Where Allowed:  client console, server console.
  ...
  more powerful than the 'set' command as it excepts the string
  ...
  but you can't blank it remoting.  You can with cvarset 
...
There are 4 server console commands to control lrcon's.
...
This script changes the clients cl_pitchspeed.  To enable the detection of 
changing cl_pitchspeed you need to edit the q2admin.txt file and change 
"cl_pitchspeed_enable" variable to "Yes".
...
is ingored (this is for technical reasons).
...
v1.8          -   9 June     - Added reconnect_checklevel to allow a less strict setup of the reconnect feature.
                             ...
                             - Changed the lock command to allow access to disconnected / disconnecting
                               users.
														 ...
														 - Fixed a bug that stoped Q2 Variant (http://www.ionwerks.net/defunkt/action/q2v.htm) from 
														   working.
